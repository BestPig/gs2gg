...
__BRYTHON__.compiled_date="2021-02-21 21:14:36.372765"
__BRYTHON__.timestamp=1613938476372
...
;
;(function($B){$B.stdlib={}
var pylist=['VFS_import','__future__','_abcoll','_codecs','_collections','_collections_abc','_compat_pickle','_contextvars','_csv','_dummy_thread','_frozen_importlib','_functools','_imp','_io','_markupbase','_operator','_py_abc','_pydecimal','_queue','_random','_socket','_sre','_struct','_sysconfigdata','_sysconfigdata_0_brython_','_testcapi','_thread','_threading_local','_weakref','_weakrefset','abc','antigravity','atexit','base64','binascii','bisect','browser.aio','browser.ajax','browser.highlight','browser.html','browser.indexed_db','browser.local_storage','browser.markdown','browser.object_storage','browser.session_storage','browser.svg','browser.template','browser.timer','browser.webcomponent','browser.websocket','browser.webworker','browser.worker','cmd','code','codecs','codeop','colorsys','contextlib','contextvars','copy','copyreg','csv','dataclasses','decimal','enum','errno','external_import','faulthandler','fnmatch','formatter','fractions','functools','gc','genericpath','getopt','gettext','glob','heapq','hmac','imp','interpreter','io','itertools','json','keyword','linecache','mimetypes','nntplib','ntpath','numbers','opcode','operator','os','pathlib','pkgutil','platform','posixpath','pprint','profile','pwd','py_compile','queue','quopri','re','reprlib','select','selectors','shlex','shutil','signal','site','site-packages.__future__','site-packages.docs','site-packages.header','site-packages.test_sp','socket','sre_compile','sre_constants','sre_parse','stat','string','stringprep','struct','sys','sysconfig','tb','tempfile','textwrap','this','threading','time','timeit','token','tokenize','traceback','types','uu','uuid','warnings','weakref','webbrowser','zipimport','zlib']
...
var pkglist=['browser.widgets','collections','html','importlib','site-packages.simpleaio','site-packages.ui']
